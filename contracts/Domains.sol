...
contract Domains is ERC721URIStorage {
    ...
    constructor(string memory _tld) payable ERC721("Anon Name Service", "ANS") {
        tld = _tld;
    ...
    function register(string calldata name) public payable {
        ...
        string memory _name = string(abi.encodePacked(tld, ".", name));
        ...
        _tokenIds.increment();
        console.log(
            "Domain %s.%s has been registered to %s",
            tld,
            name,
            msg.sender
        );
